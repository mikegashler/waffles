...
class GDistanceMetric;
  ...
  namespace SOM{
    ...
    public:
      ...
      ///generated by pRand.  rand is assumed to have a lifetime
      ///exceeding the lifetime of this object.
    ...
    public:
      ...
      /// Return a reference to the pseudo-random number generator used
      /// by this object.
...
public:
  ...
  GSelfOrganizingMap(int nMapDims, int nMapWidth, GRand& rand,
